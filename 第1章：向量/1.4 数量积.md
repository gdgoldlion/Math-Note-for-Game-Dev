...
对于矩阵形式，不用写点乘符号•，记作<img src="https://latex.codecogs.com/gif.latex?{P^T}Q" title="{P^T}Q" />
...
4. <img src="https://latex.codecogs.com/gif.latex?P&space;\cdot&space;P&space;=&space;{\left|&space;P&space;\right|^2}" title="P \cdot P = {\left| P \right|^2}" />
5. 柯西-施瓦茨不等式（ cauchy-schwarz）：<img src="https://latex.codecogs.com/gif.latex?\left|&space;{P&space;\cdot&space;Q}&space;\right|&space;\le&space;\left|&space;P&space;\right|\left|&space;Q&space;\right|" title="\left| {P \cdot Q} \right| \le \left| P \right|\left| Q \right|" />
...
<img src="https://latex.codecogs.com/gif.latex?\left|&space;{P&space;\cdot&space;Q}&space;\right|&space;=&space;\left|&space;P&space;\right|\left|&space;Q&space;\right|\left|&space;{\cos&space;\alpha&space;}&space;\right|" title="\left| {P \cdot Q} \right| = \left| P \right|\left| Q \right|\left| {\cos \alpha } \right|" />

因为<img src="http://latex.codecogs.com/gif.latex?\left| {\cos \alpha } \right| \le 1">所以，可知：

<img src="https://latex.codecogs.com/gif.latex?\left|&space;{P&space;\cdot&space;Q}&space;\right|&space;\le&space;\left|&space;P&space;\right|\left|&space;Q&space;\right|" title="\left| {P \cdot Q} \right| \le \left| P \right|\left| Q \right|" />
